...
with st.container():
    if col1.button("Station Statistics"):
        display_multiple_obsids_gains_stats(all_nights, "mpi_dd", "gg_I", "stations")

    if col2.button("Cluster Statistics"):
        display_multiple_obsids_gains_stats(all_nights, "mpi_dd", "gg_I", "clusters")

    if clear_cache.button("Clear DD cache"):
