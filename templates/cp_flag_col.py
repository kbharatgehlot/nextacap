...
parser.add_argument('-t','--table_name', help='table name,default=table.f4_TSM0',dest='table_name',default='table.f4_TSM0')
parser.add_argument('-o','--outname', help='output name,default=table.f4_TSM0_copy',dest='outname',default='table.f4_TSM0_copy')
