...
process ApplyPreDIFlag {
    ...
    """
    echo "[Info] We assume the simulation does not need any visibilities flagging before DI calibration."
    """
...
process ApplyPreDDFlag {
    ...
    """
    echo "[Info] We assume the simulation does not need any visibilities flagging before DD calibration."
    """
...
def checkParams() {
    ...
    assert params.tasks : log.error("Error:'At least 1 task is required")
